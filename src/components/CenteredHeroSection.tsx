...
const CenteredHeroSection: React.FC = () => {
  ...
  return <section className="py-16 lg:py-24 bg-transparent">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in delay-2">
            <Button onClick={handleBrowseRaffles} className="rounded-full text-white font-bold px-8 py-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 transform text-xl" style={{
