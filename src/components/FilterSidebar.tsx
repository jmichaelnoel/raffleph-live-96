        ...
        <div className="mb-5 animate-slide-up">
          ...
          <div className="mb-3 px-1">
            <Slider 
              ...
              className="py-3 [&_.h-2]:bg-gray-200 [&_[role=slider]]:bg-white [&_[role=slider]]:border-2 [&_[role=slider]]:border-yellow-500 [&_[role=slider]]:shadow-lg [&_[role=slider]]:hover:scale-110 [&_[role=slider]]:transition-transform [&_.absolute.h-full]:bg-gradient-to-r [&_.absolute.h-full]:from-yellow-400 [&_.absolute.h-full]:via-yellow-500 [&_.absolute.h-full]:to-yellow-600"
            />
          </div>
        ...
        <div className="mb-5 animate-slide-up delay-150">
          ...
          <div className="mb-3 px-1">
            <Slider 
              ...
              className="py-3 [&_.h-2]:bg-gray-200 [&_[role=slider]]:bg-white [&_[role=slider]]:border-2 [&_[role=slider]]:border-green-500 [&_[role=slider]]:shadow-lg [&_[role=slider]]:hover:scale-110 [&_[role=slider]]:transition-transform [&_.absolute.h-full]:bg-gradient-to-r [&_.absolute.h-full]:from-green-400 [&_.absolute.h-full]:via-green-500 [&_.absolute.h-full]:to-green-600"
            />
          </div>
          <div className="flex justify-between text-sm font-medium">
        ...
        <div className="mb-5 animate-slide-up delay-300">
          ...
          <div className="mb-3 px-1">
            <Slider 
              ...
              className="py-3 [&_.h-2]:bg-gray-200 [&_[role=slider]]:bg-white [&_[role=slider]]:border-2 [&_[role=slider]]:border-blue-500 [&_[role=slider]]:shadow-lg [&_[role=slider]]:hover:scale-110 [&_[role=slider]]:transition-transform [&_.absolute.h-full]:bg-gradient-to-r [&_.absolute.h-full]:from-blue-400 [&_.absolute.h-full]:via-blue-500 [&_.absolute.h-full]:to-blue-600"
            />
          </div>
          <div className="flex justify-between text-sm font-medium">
