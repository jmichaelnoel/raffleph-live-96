        ...
        <div className="mb-5 animate-slide-up">
          ...
          <div className="mb-3 px-1">
            <Slider 
              ...
              className="py-3 [&_.h-2]:bg-gradient-to-r [&_.h-2]:from-yellow-400 [&_.h-2]:via-yellow-500 [&_.h-2]:to-yellow-600 [&_[role=slider]]:bg-white [&_[role=slider]]:border-2 [&_[role=slider]]:border-yellow-500 [&_[role=slider]]:shadow-lg [&_[role=slider]]:hover:scale-110 [&_[role=slider]]:transition-transform [&_.absolute.h-full]:bg-gray-200"
            />
          </div>
        ...
        <div className="mb-5 animate-slide-up delay-150">
          ...
          <div className="mb-3 px-1">
            <Slider 
              ...
              className="py-3 [&_.h-2]:bg-gradient-to-r [&_.h-2]:from-green-400 [&_.h-2]:via-green-500 [&_.h-2]:to-green-600 [&_[role=slider]]:bg-white [&_[role=slider]]:border-2 [&_[role=slider]]:border-green-500 [&_[role=slider]]:shadow-lg [&_[role=slider]]:hover:scale-110 [&_[role=slider]]:transition-transform [&_.absolute.h-full]:bg-gray-200"
            />
          </div>
          <div className="flex justify-between text-sm font-medium">
        ...
        <div className="mb-5 animate-slide-up delay-300">
          ...
          <div className="mb-3 px-1">
            <Slider 
              ...
              className="py-3 [&_.h-2]:bg-gradient-to-r [&_.h-2]:from-blue-400 [&_.h-2]:via-blue-500 [&_.h-2]:to-blue-600 [&_[role=slider]]:bg-white [&_[role=slider]]:border-2 [&_[role=slider]]:border-blue-500 [&_[role=slider]]:shadow-lg [&_[role=slider]]:hover:scale-110 [&_[role=slider]]:transition-transform [&_.absolute.h-full]:bg-gray-200"
            />
          </div>
          <div className="flex justify-between text-sm font-medium">
